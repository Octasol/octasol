...
const Leaderboard = () => {
  ...
  const response = async () => {
    ...
    console.log(res);
    setProfile(res);
    setTopProfiles([res[1], res[0], res[2]]);
  };
    ...
    <>
      ...
      <div className="w-full h-fit ">
        <div className="w-full flex justify-center items-center py-10">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-9/12 place-items-center">
            {topProfiles &&
              topProfiles.map((profile: any, index: number) => (
                <div className="w-10/12 block justify-center items-center relative">
