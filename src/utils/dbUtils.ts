...
export const initializeUser = async (
  ...
  try {
    ...
    await logToDiscord(`dbUtils/initializeUser for ${githubId}: ${(error as any).message}`, "ERROR");
    console.error(error);
    return false;
  }
};
...
export const setUser = async (
  ...
  try {
    ...
    await logToDiscord(`dbUtils/setUser for ${githubId}:${(error as any).message}`, "ERROR");
    console.error(error);
    return false;
  }
};
...
export const setUsername = async (id: bigint, username: UserDB) => {
  try {
    ...
    await logToDiscord(`dbUtils/setUsername for ${id}: ${(error as any).message}`, "ERROR");
    console.error(error);
    return false;
  }
};
...
export const setGithubDevProfile = async (
  ...
  try {
    ...
    await logToDiscord(`dbUtils/setGithubDevProfile for ${id}: ${(error as any).message}`, "ERROR");
    console.error(error);
    return false;
  }
};
...
export const setHackerrankProfile = async (id: bigint, profile: any) => {
  try {
    ...
    await logToDiscord(`dbUtils/setHackerrankProfile for ${id}: ${(error as any).message}`, "ERROR");
    console.error(error);
    return false;
  }
};
...
export async function setHackerrankDatabyGithubId(
  ...
  try {
    ...
    await logToDiscord(`dbUtils/setHackerrankDatabyGithubId for ${githubId}: ${(error as any).message}`, "ERROR");
    console.error(error);
    return false;
  }
}
...
export async function setGFGDatabyGithubId(
  ...
  try {
    ...
    await logToDiscord(`dbUtils/setGFGDatabyGithubId for ${githubId}: ${(error as any).message}`, "ERROR");
    console.error(error);
    return false;
  }
}
...
export async function setCodeChefDatabyGithubId(
  ...
  try {
    ...
    await logToDiscord(`dbUtils/setCodeChefDatabyGithubId for ${githubId}: ${(error as any).message}`, "ERROR");
    console.error(error);
    return false;
  }
}
...
export async function setLeetCodeDatabyGithubId(
  ...
  try {
    ...
    await logToDiscord(`dbUtils/setLeetCodeDatabyGithubId for ${githubId}: ${(error as any).message}`, "ERROR");
    console.error(error);
    return false;
  }
}
...
export async function setSuperteamEarnDatabyGithubId(
  ...
  try {
    ...
    await logToDiscord(`dbUtils/setSuperteamEarnDatabyGithubId for ${githubId}: ${(error as any).message}`, "ERROR");
    console.error(error);
    return false;
  }
}
...
export const getUserProfileForRadarChart = async (githubUsername: string) => {
  try {
    ...
    await logToDiscord(`dbUtils/getUserProfileForRadarChart for ${githubUsername}: ${(error as any).message}`, "ERROR");
