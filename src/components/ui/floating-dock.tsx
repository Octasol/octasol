        ...
        <AnimatePresence>
          {hovered && (
            <motion.div
              ...
              className="px-2 py-0.5 whitespace-pre rounded-md bg-secondary-background border dark:bg-neutral-800 dark:border-neutral-900 dark:text-white border-secondary-background text-neutral-700 absolute top-[-12px] -translate-x-1/2 -translate-y-full w-fit text-xs"
            >
              {title}
            </motion.div>
          )}
